/*:name = GoTo - Next Low Confidence :description=Jump to next segment with a note matching the filter
 *
 *  @author:   Kos Ivantsov
 *  @date:     2024-08-19
 *  @version:  0.2
...
filtered_note = new File(prop.getProjectRoot() + "config" + File.separator + "below_thrshld.txt")
